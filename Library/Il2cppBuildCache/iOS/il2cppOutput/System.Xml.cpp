...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR XmlAttribute_t4B6CC461196FBF5CC9F777E74CC82C98E0CA9D18* XmlAttributeCollection_get_ItemOf_m8F968C39C03DFEB9998B2122F4A26B76B1DB2EDB (XmlAttributeCollection_tB0BA25B3C7E8D4BCF487C7107A9019632A7D85C0* __this, int32_t ___0_i, const RuntimeMethod* method) 
{
	...
	try
	{// begin try (depth: 1)
		SmallXmlNodeList_tAF536F4BFCA26BF1B0E912818E921A3181D49EF0* L_0 = (&((XmlNamedNodeMap_t13203D1B3861C62568AFFA1D644C04ABCBFC130C*)__this)->___nodes_0);
		int32_t L_1 = ___0_i;
		RuntimeObject* L_2;
...
CATCH_0014:
	{// begin catch(System.ArgumentOutOfRangeException)
		String_t* L_3;
		L_3 = Res_GetString_mBEE82ACFE97F93A6DDE81E322477CF2713466364(((String_t*)il2cpp_codegen_initialize_runtime_metadata_inline((uintptr_t*)&_stringLiteral3C67F6F3D5AD1DF5DD1E3B7F8583419767796154)), NULL);
...
{
	{
		SmallXmlNodeList_tAF536F4BFCA26BF1B0E912818E921A3181D49EF0* L_0 = (&__this->___nodes_0);
		int32_t L_1;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR XmlNode_t3180B9B3D5C36CD58F5327D9F13458E3B3F030AF* XmlNode_get_FirstChild_m5F667C696492597141F3F92F048DB73C5546F1CD (XmlNode_t3180B9B3D5C36CD58F5327D9F13458E3B3F030AF* __this, const RuntimeMethod* method) 
{
	XmlLinkedNode_t640BF5D3FDAF0606665C3BAE565988A5014F1B9C* V_0 = NULL;
	{
		...
		L_0 = VirtualFuncInvoker0< XmlLinkedNode_t640BF5D3FDAF0606665C3BAE565988A5014F1B9C* >::Invoke(9 /* System.Xml.XmlLinkedNode System.Xml.XmlNode::get_LastNode() */, __this);
		V_0 = L_0;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void XmlNode_AppendChildText_m8C1493DF2F031942BD58F96DE8EFC365194561A1 (XmlNode_t3180B9B3D5C36CD58F5327D9F13458E3B3F030AF* __this, StringBuilder_t* ___0_builder, const RuntimeMethod* method) 
{
	XmlNode_t3180B9B3D5C36CD58F5327D9F13458E3B3F030AF* V_0 = NULL;
	{
		...
		L_0 = VirtualFuncInvoker0< XmlNode_t3180B9B3D5C36CD58F5327D9F13458E3B3F030AF* >::Invoke(8 /* System.Xml.XmlNode System.Xml.XmlNode::get_FirstChild() */, __this);
		V_0 = L_0;
		goto IL_0054;
	}
...
IL_0009:
	{
		...
		L_2 = VirtualFuncInvoker0< XmlNode_t3180B9B3D5C36CD58F5327D9F13458E3B3F030AF* >::Invoke(8 /* System.Xml.XmlNode System.Xml.XmlNode::get_FirstChild() */, L_1);
		if (L_2)
		{
			goto IL_0046;
		}
	}
	{
		...
		NullCheck(L_3);
		int32_t L_4;
		L_4 = VirtualFuncInvoker0< int32_t >::Invoke(5 /* System.Xml.XmlNodeType System.Xml.XmlNode::get_NodeType() */, L_3);
	...
	}
	{
		...
		NullCheck(L_5);
		int32_t L_6;
		L_6 = VirtualFuncInvoker0< int32_t >::Invoke(5 /* System.Xml.XmlNodeType System.Xml.XmlNode::get_NodeType() */, L_5);
	...
	}
	{
		...
		NullCheck(L_7);
		int32_t L_8;
		L_8 = VirtualFuncInvoker0< int32_t >::Invoke(5 /* System.Xml.XmlNodeType System.Xml.XmlNode::get_NodeType() */, L_7);
	...
	}
	{
		...
		NullCheck(L_9);
		int32_t L_10;
		L_10 = VirtualFuncInvoker0< int32_t >::Invoke(5 /* System.Xml.XmlNodeType System.Xml.XmlNode::get_NodeType() */, L_9);
...
IL_0037:
	{
		...
		NullCheck(L_12);
		String_t* L_13;
		L_13 = VirtualFuncInvoker0< String_t* >::Invoke(10 /* System.String System.Xml.XmlNode::get_InnerText() */, L_12);
		NullCheck(L_11);
...
IL_004d:
	{
		...
		L_18 = VirtualFuncInvoker0< XmlNode_t3180B9B3D5C36CD58F5327D9F13458E3B3F030AF* >::Invoke(6 /* System.Xml.XmlNode System.Xml.XmlNode::get_NextSibling() */, L_17);
		V_0 = L_18;
	}
...
IL_0010:
	{
		...
		L_4 = VirtualFuncInvoker0< XmlNode_t3180B9B3D5C36CD58F5327D9F13458E3B3F030AF* >::Invoke(6 /* System.Xml.XmlNode System.Xml.XmlNode::get_NextSibling() */, L_3);
		if (L_4)
		{
			goto IL_0033;
		}
...
IL_002c:
	{
		...
		NullCheck(L_9);
		String_t* L_10;
		L_10 = VirtualFuncInvoker0< String_t* >::Invoke(4 /* System.String System.Xml.XmlNode::get_Value() */, L_9);
		return L_10;
	}
